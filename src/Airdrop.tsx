...
// const Airdrop: React.FC<AirdropProps> = ({ setCurrentPage }) => {
//   return (
...
//           </div>
//           <div className="text-center text-[#50e3c2] w-1/5" onClick={() => setCurrentPage('mine')}>
...
//           </div>
//           <div className="text-center text-[#50e3c2] w-1/5 active-icon" onClick={() => setCurrentPage('airdrop')}>
...
const Airdrop: React.FC<AirdropProps> = ({ setCurrentPage, profitPerHour }) => {
