...
import NavButtons from "./assets/components/NavButtons";
...
const App: React.FC = () => {
  ...
  const [currentPage, setCurrentPage] = useState("Mine");
  ...
  const renderHomePage = () => (
    <div className="bg-[#dfe6e9] flex justify-center">
      <div className="w-full bg-[#dfe6e9] text-[#2d3436] h-screen font-bold flex flex-col max-w-xl">
        {/* div below is for header info such as CEO */}
        <div className="px-4 z-10">
          <div className="flex items-center space-x-2 pt-4">
            <div className="p-0 rounded-lg bg-[#74b9ff]">
              <Hamster size={20} className="text-[#2d3436]" />
            </div>
            <div>
          ...
          <div className="flex items-center justify-between space-x-4 mt-1">
            ...
            <div className="flex items-center w-2/3 border-2 border-[#6c5ce7] rounded-full px-4 py-[2px] bg-[#6c5ce7]/[0.6] max-w-64">
              ...
              <div className="flex-1 text-center">
                <p className="text-xs text-[#50e3c2] font-medium">
                  Profit per hour
                </p>
        ...
        <div className="flex-grow mt-4 bg-[#74b9ff] rounded-t-[48px] relative z-0">
          {/* component below shows the current infoe.g points, hamster */}
          <div className="absolute top-[2px] left-0 right-0 bottom-0 bg-[#dfe6e9] rounded-t-[46px]">
            <div className="px-4 mt-6 flex justify-between gap-2">
              <div className="bg-[#6c5ce7] rounded-lg px-4 py-2 w-full relative">
                ...
                />
                <p className="text-[10px] text-center text-[#2d3436] mt-1">
                  Daily reward
                </p>
                ...
                {dailyRewardTimeLeft === "00:00" && (
                  <button
                    ...
                    className="text-white mt-2 bg-blue-500 rounded px-2 py-1"
                  >
                    Collect
                  </button>
                )}
              ...
              <div className="bg-[#6c5ce7] rounded-lg px-4 py-2 w-full relative">
                ...
                {dailyComboTimeLeft === "00:00" && (
                  <button
                    onClick={collectDailyCombo}
                    className="text-white mt-2 bg-blue-500 rounded px-2 py-0"
                  >
                    Collect
                  </button>
                )}
            ...
            <div className="px-4 mt-4 flex justify-center">
              <div className="px-4 py-2 flex items-center space-x-2">
                ...
                <p className="text-2xl text-[#2d3436]">
  ...
  return (
    <>
      ...
      {currentPage === "Mine" && renderHomePage()}
    </>
  );
};
