      ...
      <div className="w-full bg-[#dfe6e9] text-[#2d3436] h-screen font-bold flex flex-col max-w-xl">
        ...
        <div className="flex-grow mt-4 bg-[#74b9ff] rounded-t-[48px] relative z-0">
          <div className="absolute top-[2px] left-0 right-0 bottom-0 bg-[#dfe6e9] rounded-t-[46px]">
            <div className="px-4 mt-6 flex flex-col space-y-4 items-center">
              <div
                className="bg-[#74b9ff] text-[#2d3436] rounded-lg shadow-lg p-4 flex items-center justify-between w-full max-w-sm mx-auto"
              ...
              >
                ...
                <div className="ml-4 flex-1">
                  ...
                  <p className="text-sm mt-1">
                    +5,000 coins for you and your friend
                  </p>
                </div>
                <button
                  className="bg-[#0984e3] text-white py-2 px-4 rounded-full"
              ...
              >
                ...
                <div className="ml-4 flex-1">
                  ...
                  <p className="text-sm mt-1">
                    {" "}
                    +10,000 coins for you and your friend
                  </p>
                </div>
                <button
                  className="bg-[#0984e3] text-white py-2 px-4 rounded-full"
            ...
            <div className="px-4 mt-8">
              ...
              <div className="mt-4 space-y-4 flex flex-col items-center">
                {friends.map((friend, index) => (
                  <div
                    key={index}
                    className="bg-[#74b9ff] text-[#2d3436] rounded-lg shadow-lg p-2 flex items-center justify-between w-full max-w-sm mx-auto"
                    style={{ borderRadius: "12px" }}
                  >
                    <Hamster size={24} className="w-8 h-8" />
                    <div className="ml-4 flex-1 flex items-center justify-between">
            ...
            <NavButtons setCurrentPage={setCurrentPage} currentPage="Friends" />
          </div>
        </div>
      </div>
    </div>
